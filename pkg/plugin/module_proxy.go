...
// ModuleProxy is a proxy that satisfies Kubefun module requirements. It allows plugins to behave as if they
...
func (m *ModuleProxy) ClientRequestHandlers() []kubefun.ClientRequestHandler {
	return nil
}
...
func (ModuleProxy) Generators() []kubefun.Generator {
