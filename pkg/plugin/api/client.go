...
//go:generate mockgen -destination=./fake/mock_dashboard_client.go -package=fake github.com/kubenext/kubefun/pkg/plugin/api/proto DashboardClient
//go:generate mockgen -destination=./fake/mock_dashboard_connection.go -package=fake github.com/kubenext/kubefun/pkg/plugin/api DashboardConnection
