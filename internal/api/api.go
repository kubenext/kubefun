...
import (
	...
	"github.com/kubenext/kubefun/internal/mime"
...
//go:generate mockgen -destination=./fake/mock_service.go -package=fake github.com/kubenext/kubefun/internal/api Service
...
func acceptedHosts() []string {
	...
	if err != nil {
		panic(fmt.Sprintf("Unable to parse KUBEFUN_LISTENER_ADDR: %s", listenerAddr))
	}
