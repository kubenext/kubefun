...
// Source: github.com/kubenext/kubefun/internal/kubefun (interfaces: Generator)
...
func (m *MockGenerator) Event(arg0 context.Context) (kubefun.Event, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Event", arg0)
	ret0, _ := ret[0].(kubefun.Event)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
