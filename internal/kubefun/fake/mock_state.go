...
// Source: github.com/kubenext/kubefun/internal/kubefun (interfaces: State)
...
func (m *MockState) AddFilter(arg0 kubefun.Filter) {
	m.ctrl.T.Helper()
...
func (m *MockState) GetFilters() []kubefun.Filter {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GetFilters")
	ret0, _ := ret[0].([]kubefun.Filter)
	return ret0
}
...
func (m *MockState) OnContentPathUpdate(arg0 kubefun.ContentPathUpdateFunc) kubefun.UpdateCancelFunc {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "OnContentPathUpdate", arg0)
	ret0, _ := ret[0].(kubefun.UpdateCancelFunc)
	return ret0
}
...
func (m *MockState) OnNamespaceUpdate(arg0 kubefun.NamespaceUpdateFunc) kubefun.UpdateCancelFunc {
	m.ctrl.T.Helper()
...
func (m *MockState) RemoveFilter(arg0 kubefun.Filter) {
	m.ctrl.T.Helper()
...
func (m *MockState) SetFilters(arg0 []kubefun.Filter) {
	m.ctrl.T.Helper()
