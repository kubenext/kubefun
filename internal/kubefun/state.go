...
//go:generate mockgen -destination=./fake/mock_state.go -package=fake github.com/kubenext/kubefun/internal/kubefun State

// UpdateCancelFunc cancels the update.
type UpdateCancelFunc func()

// State represents Kubefun's view state.
