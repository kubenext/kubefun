...
import (
	...
	kfs "github.com/kubenext/kubefun/internal/util/strings"
...
//go:generate mockgen -destination=./fake/mock_queryer.go -package=fake github.com/kubenext/kubefun/internal/queryer Queryer
...
func (osq *ObjectStoreQueryer) canList(apiResource metav1.APIResource) bool {
	return !kfs.Contains("watch", apiResource.Verbs) ||
		!kfs.Contains("list", apiResource.Verbs)
}
