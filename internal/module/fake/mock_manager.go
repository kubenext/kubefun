...
// Source: github.com/kubenext/kubefun/internal/module (interfaces: ManagerInterface)
...
func (m *MockManagerInterface) ClientRequestHandlers() []kubefun.ClientRequestHandler {
	m.ctrl.T.Helper()
