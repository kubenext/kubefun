...
// Source: github.com/kubenext/kubefun/internal/module (interfaces: Module)
...
import (
	...
	navigation "github.com/kubenext/kubefun/pkg/navigation"
...
func (m *MockModule) ClientRequestHandlers() []kubefun.ClientRequestHandler {
	m.ctrl.T.Helper()
...
func (m *MockModule) Generators() []kubefun.Generator {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Generators")
	ret0, _ := ret[0].([]kubefun.Generator)
	return ret0
}
