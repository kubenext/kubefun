...
//go:generate mockgen -destination=./fake/mock_manager.go -package=fake github.com/kubenext/kubefun/internal/module ManagerInterface
//go:generate mockgen -destination=./fake/mock_action_registrar.go -package=fake github.com/kubenext/kubefun/internal/module ActionRegistrar
...
func (m *Manager) ClientRequestHandlers() []kubefun.ClientRequestHandler {
	var list []kubefun.ClientRequestHandler
