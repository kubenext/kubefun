...
//go:generate mockgen -destination=./fake/mock_object_interface.go -package=fake github.com/kubenext/kubefun/internal/printer ObjectInterface
...
func (o *Object) ToComponent(ctx context.Context, options Options) (component.Component, error) {
	...
	if accessor.GetDeletionTimestamp() == nil {
		...
		o.AddButton("Delete", action.CreatePayload(kubefun.ActionDeleteObject,
