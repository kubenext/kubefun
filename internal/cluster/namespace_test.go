...
func TestNamespaceClient_Names(t *testing.T) {
	...
	// merged upstream
	dc := dynamicfake.NewSimpleDynamicClient(scheme, newUnstructured("v1", "Namespace", "", "default"), newUnstructured("v1", "Namespace", "", "app-1"))
...
func TestNamespaceClient_InitialNamespace(t *testing.T) {
