...
import (
	...
	cluster "github.com/kubenext/kubefun/internal/cluster"
...
func (m *MockClientInterface) ResourceExists(resource schema.GroupVersionResource) bool {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "ResourceExists", resource)
	ret0, _ := ret[0].(bool)
	return ret0
}

// ResourceExists indicates an expected call of ResourceExists
func (mr *MockClientInterfaceMockRecorder) ResourceExists(resource interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "ResourceExists", reflect.TypeOf((*MockClientInterface)(nil).ResourceExists), resource)
}

// Resource mocks base method
func (m *MockClientInterface) Resource(kind schema.GroupKind) (schema.GroupVersionResource, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "Resource", kind)
...
func (mr *MockClientInterfaceMockRecorder) Resource(kind interface{}) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "Resource", reflect.TypeOf((*MockClientInterface)(nil).Resource), kind)
}
